...
import net.orbitdev.secretsanta.net.orbitdev.secretsanta.db.InMemoryFamilyMemberStore
import net.orbitdev.secretsanta.net.orbitdev.secretsanta.db.InMemorySecretSantaStore
...
class SecretSantaApp {
    ...
    static void main(args){
        ...
        def secretSantaService = new SecretSantaService(familyMemberStore, secretSantaStore)
